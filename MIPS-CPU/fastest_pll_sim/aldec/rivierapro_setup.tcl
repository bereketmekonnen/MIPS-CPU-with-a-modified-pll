...
# ACDS 17.1 590 win32 2019.03.06.17:56:41
# ----------------------------------------
...
# ----------------------------------------
# If fastest_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fastest_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fastest_pll.vho"
}
